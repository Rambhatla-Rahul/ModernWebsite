...
const Features = () => {
  ...
  useGSAP(() =>{
    animateWithGsap('#features_title',{y:0,opacity:1,duration:2})
    animateWithGsap('.g_grow',
        {scale:1,opacity:1,ease:'power1'},
        {scrub:5.5}
    )
    animateWithGsap('.g_text',{y:0,opacity:1,ease:'power2',duration:1})
                        ...
                        <div className='flex-1 flex-center'>
                            <p className='feature-text g_text'>
                                ...
                                <span className='text-white'>
                                    the first iPhone to feature an aerospace design 
